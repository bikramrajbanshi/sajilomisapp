...
const RequestCard = ({
                       user, fields, onApprove, onRecommend, onRecommendReject, onReject, isApproved, isRejected, canApproveAndReject, canRecommendAndReject
}) => {
  const leaveTypeStyles = {
    'Sick Leave': styles.sickLeave,
    'Casual Leave': styles.casualLeave,
    'Annual Leave': styles.annualLeave,
    'Unpaid Leave': styles.unpaidLeave,
    'Official Visit': styles.officialVisit,
    'Late In/Early Out': styles.lateInEarlyOut,
  };
