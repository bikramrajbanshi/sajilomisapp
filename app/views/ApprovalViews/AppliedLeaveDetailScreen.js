...
const LeaveStatsCard = ({stats, onNumberPress}) => {
...
const AppliedLeaveDetailScreen = ({navigation}) => {
    ...
    const handleAction = async (leaveApplicationId, remarks, isApproved, isRecommended, recommendReject, approveReject) => {
        const body = {
            leaveApplicationId,
            remarks,
            isApproved,
        ...
        setIsLoading(true);
        try {
            const response = await APIKit.post('/Leave/ActionLeave', body);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.fixedCard}>
                <LeaveStatsCard stats={counts} onNumberPress={handleNumberPress}/>
            </View>
            ...
            >
                <View>
                    {leaveData[menuTab] && leaveData[menuTab].map((data, index) => {
                            ...
                            return (<RequestCard2
                                ...
                                fields={fields}
                                onApprove={() => handleAction(data.leaveApplicationId, data.remarks, true, data.isRecommended, data.recommendReject, data.approveReject)}
                                onReject={() => handleAction(data.leaveApplicationId, data.remarks, data.isApproved, data.isRecommended, data.recommendReject, true)}
                                onRecommend={() => handleAction(data.leaveApplicationId, data.remarks, data.isApproved, true, data.recommendReject, data.approveReject)}
                                onRecommendReject={() => handleAction(data.leaveApplicationId, data.remarks, data.isApproved, data.isRecommended, true, data.approveReject)}
...
export default AppliedLeaveDetailScreen;
